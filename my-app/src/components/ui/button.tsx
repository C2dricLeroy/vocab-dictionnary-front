  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        filter:
          "border border-input bg-background shadow-sm text-gray-500 hover:bg-gray-100 hover:text-gray-700",
        secondary:
        ...
        ghost:
          "hover:bg-accent hover:text-accent-foreground active:scale-95 active:shadow-inner transition-transform",
        link:
          "text-primary underline-offset-4 hover:underline active:scale-95 active:shadow-inner transition-transform",
        neumorphism:
