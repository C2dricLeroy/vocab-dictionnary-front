...
export default function WelcomeSection() {
    ...
    return (
        <section className="relative flex flex-col items-center justify-center bg-gradient-to-r from-blue-500 to-teal-400 text-white py-16 px-8 rounded-lg shadow-lg">
            <button
                onClick={handleClose}
